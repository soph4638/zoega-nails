...
export const EMAIL_CONFIG = {
    ...
    // Din egen email - her sendes en notifikation hen, hver gang en kunde
    // booker en tid, så du ikke behøver at tjekke admin-siden hele tiden.
    ownerEmail: "sophieermitnavn@gmail.com",
};
