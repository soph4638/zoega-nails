  ...
  return (
        <header className="sticky top-0 z-50 border-b border-beige bg-cream/95 backdrop-blur">
              <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
                      <Link
                                  href="/"
                                  className="font-serif text-xl italic tracking-wide text-ink"
                ...
                {/* Navigation til større skærme */}
                      ...
                      <Link
                        ...
                        {link.label}
                                ...
                                <Link
                                              href="/book"
                                              className="rounded-sm bg-accent px-5 py-2.5 text-[11px] uppercase tracking-[0.2em] text-white transition-colors hover:bg-accent-dark"
                                            >
                                            Book tid
                                </Link>
                      </nav>
                  ...
                  <nav className="flex flex-col gap-1 border-t border-beige px-4 pb-4 sm:hidden">
                    {navLinks.map((link) => (
                                <Link
                                                ...
                                                href={link.href}
                                                onClick={() => setMenuOpen(false)}
                                                className={`rounded-lg px-3 py-3 text-sm uppercase tracking-widest ${
                            ...
                            <Link
                                          href="/book"
                                          onClick={() => setMenuOpen(false)}
                                          className="mt-2 rounded-sm bg-accent px-5 py-3 text-center text-sm uppercase tracking-widest text-white"
                                        >
                                        Book tid
                            </Link>
                  </nav>
